# Generated by Django 4.2.7 on 2025-12-19 19:27

from django.db import migrations


def add_default_categories_and_materials(apps, schema_editor):
    """Add default categories and materials to the database"""
    Category = apps.get_model('marketplace', 'Category')
    Material = apps.get_model('marketplace', 'Material')
    
    # Default Categories
    categories_data = [
        {'name': 'Metals', 'name_ar': 'المعادن', 'description': 'Recyclable metal materials including aluminum, copper, steel, and iron'},
        {'name': 'Plastics', 'name_ar': 'البلاستيك', 'description': 'Various types of recyclable plastic materials'},
        {'name': 'Paper & Cardboard', 'name_ar': 'الورق والكرتون', 'description': 'Recyclable paper products, cardboard, and packaging materials'},
        {'name': 'Glass', 'name_ar': 'الزجاج', 'description': 'Recyclable glass materials including bottles, windows, and containers'},
        {'name': 'Wood', 'name_ar': 'الخشب', 'description': 'Recyclable wood materials, pallets, and furniture'},
        {'name': 'Electronics', 'name_ar': 'الإلكترونيات', 'description': 'E-waste and recyclable electronic components'},
        {'name': 'Textiles', 'name_ar': 'المنسوجات', 'description': 'Recyclable fabric, clothes, and textile materials'},
        {'name': 'Rubber', 'name_ar': 'المطاط', 'description': 'Recyclable rubber materials including tires'},
        {'name': 'Construction Materials', 'name_ar': 'مواد البناء', 'description': 'Recyclable construction waste and building materials'},
        {'name': 'Organic Waste', 'name_ar': 'النفايات العضوية', 'description': 'Compostable and organic recyclable materials'},
    ]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('marketplace', '0004_cart_cartitem_and_more'),
    ]

    operations = [
        migrations.RunPython(add_default_categories_and_materials),
    ]
